...
public:
    ...
    enum PredefinedProperty
    {
        ...
        /** 
         * A combination of elements that define a unique identifier. For
         * example, this property might be defined to be a string of the
         * form <current task>_<hostname>_<pid>_<start time>. 
         */
        UNIQUE_ID,
