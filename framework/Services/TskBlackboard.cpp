...
const string TskBlackboard::TSK_DEVICE_MODEL = "MODEL"; ///< String of manufacturer name of device that was connected (or somehow related to) the data being analyzed
...
const string TskBlackboard::TSK_DEVICE_ID = "ID";   ///< String of ID of a device that was connected (or somehow related to) the data being analyzed
...
const string TskBlackboard::TSK_TEXT = "TEXT";      ///< String of text extracted from a file.
