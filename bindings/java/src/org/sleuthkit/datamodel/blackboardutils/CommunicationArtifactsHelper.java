...
public final class CommunicationArtifactsHelper extends AbstractArtifactHelper {
     ...
     * @param phoneNumber primary phone number for contact, may be empty or null
     ...
     * @param emailAddr Email address for contact,  may be empty or null
     * 
     ...
     * @param emailAddr Email address for contact,  may be empty or null
     * 
     * @param additionalAttributes additional attributes for contact, may be an empty list
     * 
    ...
    public BlackboardArtifact addMessage( String messageType, 
        ...
        try {
            ...
            if (readStatus != MessageReadStatusEnum.UNKNOWN) {
                attributes.add(new BlackboardAttribute(ATTRIBUTE_TYPE.TSK_READ_STATUS, getModuleName(), (readStatus == MessageReadStatusEnum.READ) ? 1 : 0));
            }
