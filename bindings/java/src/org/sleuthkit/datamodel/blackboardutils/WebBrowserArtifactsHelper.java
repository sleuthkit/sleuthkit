 ...
 *
 * This class helps ingest modules create sundry/misc artifacts.
 * 
 */
public final class WebBrowserArtifactsHelper extends AbstractArtifactHelper {
     ...
     * @param progName application/program that created bookmark, may be empty/null
     * 
     ...
     * @param programName name of the application that created the cookie, may be empty or null
     * 
    ...
    */
     ...
     * @param programName, application recording the history, may be empty or null
     * 
     * @return artifact created
     */
