...
public class LayoutFile extends AbstractFile {
	...
	protected LayoutFile(SleuthkitCase db, long objId, String name,
		...
		this(db, objId, db.getDataSourceObjectId(objId), name, fileType, dirType, metaType, dirFlag, metaFlags, size, 0L, 0L, 0L, 0L, md5Hash, null, knownState, parentPath, null, OsAccount.NULL_OWNER_ID, OsAccount.NO_ACCOUNT);
	}
}
