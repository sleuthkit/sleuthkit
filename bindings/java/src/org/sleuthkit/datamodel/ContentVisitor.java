 ...
 * implementations.  
 * Visitor implements an algorithm on the content object. 
 * The algorithm is completely decoupled from the content object.
 ...
 * E.g.  it allows for processing a Content object hierarchy without using instanceof statements.
...
public interface ContentVisitor<T> {
	...
	/**
	 * The default content visitor - quickest method for implementing a custom visitor.  
