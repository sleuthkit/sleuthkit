...
public abstract class SpecialDirectory extends AbstractFile {
	...
	SpecialDirectory(SleuthkitCase db,
		...
		super(db, objId, dataSourceObjectId, attrType, attrId, name,
				...
				metaFlags, size, ctime, crtime, atime, mtime, modes, uid, gid, md5Hash, sha256Hash, knownState, parentPath, mimeType, null, OsAccount.NULL_UID_STR, OsAccount.NO_ACCOUNT, Collections.emptyList());
	}
