...
public abstract class SpecialDirectory extends AbstractFile {
	...
	SpecialDirectory(SleuthkitCase db,
		...
		super(db, objId, dataSourceObjectId, fileSystemObjectId, attrType, attrId, name,
				...
				metaFlags, size, ctime, crtime, atime, mtime, modes, uid, gid, md5Hash, sha256Hash, sha1Hash, knownState, parentPath, mimeType, null, OsAccount.NO_OWNER_ID, OsAccount.NO_ACCOUNT, TskData.LocationType.UNKNOWN, Collections.emptyList());
	}
