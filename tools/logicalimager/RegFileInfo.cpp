...
RegFileInfo::RegFileInfo(string aName, string aPath, RegHiveType::Enum a_hiveType, TSK_OFF_T aOff, TSK_INUM_T aMetaAddr, RegParser *a_regParser) :
        m_name(aName),
        m_path(aPath),
...
RegFileInfo::~RegFileInfo()
{
 ...
 RegHiveType::Enum RegFileInfo::hiveNameToType(const string aName) 
 {
