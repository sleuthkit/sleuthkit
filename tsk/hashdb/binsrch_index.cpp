    ...
    hdb_binsrch_idx_initialize(TSK_HDB_BINSRCH_INFO *hdb_binsrch_info, TSK_TCHAR *htype)
{
    ...
    * settings */
    ...
    TSNPRINTF(hdb_binsrch_info->uns_fname, flen,
        _TSK_T("%") PRIcTSK _TSK_T("-%") PRIcTSK _TSK_T("-ns.idx"), hdb_binsrch_info->base.db_fname,
